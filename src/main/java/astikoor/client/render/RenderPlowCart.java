...
import astikoor.client.model.ModelPlowCart;
...
{
    private static final ResourceLocation TEXTURE = new ResourceLocation(Astikoor.MODID, "textures/entity/plowcart.png");
