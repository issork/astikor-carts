...
public class AstikorCartsConfig {
    ...
    public static class Common {
        ...
        Common(Builder builder) {
            ...
            SPEEDMODIFIER = builder.comment("Speed modifier for when the sprint key is pressed while riding a living entity")
                    .worldRestart()
                    .defineInRange("speedModifier", -0.65, -1.0, 0.0);

            CARGOCART = builder.comment("List of entities that are allowed to pull this cart.")
            ...
            PLOWCART = builder.comment("List of entities that are allowed to pull this cart.")
            ...
            MOBCART = builder.comment("List of entities that are allowed to pull this cart.")
            ...
            Map<String, Object> itemReplaceMap = new HashMap<>();
            Map<String, Object> hoeReplaceMap = new HashMap<>();
            ...
            Map<String, Object> shovelReplaceMap = new HashMap<>();
            ...
            REPLACEMAP = builder.comment("<new block> -> <old blocks> mappings to replace blocks (for example to till dirt with a hoe)."
