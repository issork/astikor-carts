...
public class SPacketEntityCartUpdate implements IMessage
{
    private int pullingId;
    private int cartId;

    public SPacketEntityCartUpdate()
    {

    }

    public SPacketEntityCartUpdate(int horseIn, int cartIn)
    {
        pullingId = horseIn;
        cartId = cartIn;
    }
    ...
    public static class EntityCartUpdatePacketHandler implements IMessageHandler<SPacketEntityCartUpdate, IMessage>
    {
        @Override
        public IMessage onMessage(SPacketEntityCartUpdate message, MessageContext ctx)
        {
