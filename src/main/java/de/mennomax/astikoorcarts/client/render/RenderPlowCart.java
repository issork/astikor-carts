package de.mennomax.astikoorcarts.client.render;

import de.mennomax.astikoorcarts.AstikoorCarts;
import de.mennomax.astikoorcarts.client.model.ModelPlowCart;
...
{
    private static final ResourceLocation TEXTURE = new ResourceLocation(AstikoorCarts.MODID, "textures/entity/plowcart.png");
