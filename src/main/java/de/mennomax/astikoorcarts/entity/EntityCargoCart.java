...
import de.mennomax.astikoorcarts.packets.SPacketCargoLoad;
...
public class EntityCargoCart extends AbstractDrawn implements IInventoryChangedListener
{
    public int load;
    ...
    {
        this.load = additionalData.readInt();
